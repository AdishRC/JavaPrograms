...
public class ExtentReportClass extends BaseTest implements ITestListener {
	...
	public static ExtentReports extentReports() {
		File file = new File("extent reports/report.html");
		ExtentSparkReporter sparkReporter = new ExtentSparkReporter(file);
		ExtentSparkReporterConfig sparkConfig = sparkReporter.config();
		sparkConfig.setDocumentTitle("FFC Automation Test Reports");
		sparkConfig.setReportName("FFC Test Results");
		sparkConfig.setTimeStampFormat("dd-MM-yyyy hh:mm:ss");

		extentReports = new ExtentReports();
		extentReports.setSystemInfo("OS", "Windows 10 Pro");
		extentReports.setSystemInfo("App Url", "https://dev.fieldforceconnect.com/auth/login");
		extentReports.setSystemInfo("Browser", "Chrome Version 129.0.6668.70");
	...
	public void onTestStart(ITestResult result) {
		...
		extentTest.assignAuthor("Adish Chaudhari");
